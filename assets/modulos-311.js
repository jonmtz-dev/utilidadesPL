/* ==========================================================================
   Paleta institucional de los módulos de Prepa en Línea (Moodle 3.11).
   Por módulo: [fondo de página, barra de título/sección, fondo de contenido].

   FUENTE ÚNICA: la usan el Integrador HTML y el Generador de Bibliografías.
   Vive en assets/ por la misma razón que docx.js: duplicarla es como se quedó
   vivo el hex #d8a7b6 meses en una copia ya corregida en la otra.
   ========================================================================== */
